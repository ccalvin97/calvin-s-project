# -*- coding: utf-8 -*-
"""run_classifier_v12_one_feature.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1-UFUNKoULvAdegGxXZFNp9gwkN6NqnGR
"""
...
import model_utils
import function_bulder_one as function_builder
...
flags.DEFINE_integer("train_steps", default=60000,        ################ training loops
...
flags.DEFINE_integer("save_steps", default=2000,  #### how often save check point in xlnet/exp/sts-b
      help="Save the model for every save_steps. "
      "If None, not to save any model.")
flags.DEFINE_integer("star_from_dev", default=20, ## start from which checkpoint in the checkpoint list
...
# label_id=label_id)
    ...
    if label_list is not None:        ###go into this requirement###
      features["label_ids"] = create_float_feature([float(feature.label_id)]) ## er]
...
# label_id=label_id)
    ...
    if label_list is not None:        ###go into this requirement###
      features["label_ids"] = create_float_feature([float(feature.label_id)]) ## error ##
#     else:
#       features["label_ids"] = create_float_feature([float(feature.label_id)])
    features["is_real_example"] = create_int_feature(
        [int(feature.is_real_example)])
